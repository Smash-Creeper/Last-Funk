...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		healthBarBG = new AttachedSprite('amogus');
		...
		healthBar = new FlxBar(healthBarBG.x + 8, healthBarBG.y + 32, RIGHT_TO_LEFT, Std.int(healthBarBG.width - 28), Std.int(healthBarBG.height - 38), this,
		 'health', 0, 2);
